...
class AlgorithmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create algorithm" do
    assert_difference("Algorithm.count") do
      post algorithms_url, params: { algorithm: { category_id: @algorithm.category_id, description: @algorithm.description, difficulty_id: @algorithm.difficulty_id, name: @algorithm.name } }
    end
  ...
  test "should update algorithm" do
    patch algorithm_url(@algorithm), params: { algorithm: { category_id: @algorithm.category_id, description: @algorithm.description, difficulty_id: @algorithm.difficulty_id, name: @algorithm.name } }
